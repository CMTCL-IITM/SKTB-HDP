...
% load tb parameters
Oeg=t(1);Ot2g=t(2);Vdds=t(3);Vddp=t(4);Vddd=t(5);VssA=t(6);OssA=t(7);VsdA=t(8);
%
nat = size(pos,1);
...
%% basis order --  x2, z2, xy, xz, yz

Hdd =  [OssA+ss,conj(z2s),conj(x2s),conj(xys),conj(xzs),conj(yzs);
        z2s,    Oeg+z2z2,       z2x2, z2xy,  z2xz,  z2yz;
        x2s,conj(z2x2), Oeg+x2x2, x2xy,  x2xz,  x2yz;
